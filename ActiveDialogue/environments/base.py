...
class DSTEnv():
  ...
  def __init__(self, dataset_wrapper, load_model, test, args):
    ...
    self._dataset, self._ontology, self._vocab, self._Eword = dataset_wrapper.load_dataset()

    # Load model
    model = load_model(args.model, args, self._ontology, self._vocab)
    model.load_emb(self._Eword)
